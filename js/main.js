...
const translations = {
  en: {
    ...
    quick_quote_title: "Need a fast event quote?",
    quick_quote_text: "Send your date, city, guest count, and event details in less than a minute.",
    quick_quote_btn: "Request Quick Quote",
 ...
 // ✅ HOME (index.html)
    ...
    quick_quote_title: "¿Necesitas una cotización rápida?",
    quick_quote_text: "Envía tu fecha, ciudad, invitados y detalles del evento en menos de un minuto.",
    quick_quote_btn: "Pedir cotización rápida",
